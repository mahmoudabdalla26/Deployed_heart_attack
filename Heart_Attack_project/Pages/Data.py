...
df = pd.read_csv(r"C:\Users\Lenovo\Desktop\mid\Heart_Attack_project\Sourse\heart_2022_with_nans.csv")
st.write(df)
...
df = pd.read_csv(r"C:\Users\Lenovo\Desktop\mid\Heart_Attack_project\Sourse\cleaned_data.csv")
st.write(df)